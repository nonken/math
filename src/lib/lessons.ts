    ...
    steps: [
      {
        id: '4-discover-50',
        type: 'intro',
        tutorText: 'Een spel kost \u20ac80. Je krijgt 50% korting. 50% = de helft! De helft van \u20ac80 = \u20ac40. Makkelijk!',
        showComponents: ['fillingBar-50-80', 'insight'],
      },
      {
        id: '4-discover-25',
        type: 'explore',
        tutorText: 'Nu 25%! 25% = een kwart. Een kwart van \u20ac80? Zet het percentage op 25.',
        interaction: 'slider',
        target: { percentage: 25 },
        showComponents: ['fillingBar', 'percentageSlider', 'insight'],
        hint: 'Schuif naar 25%. Een kwart = deel door 4!',
      },
      {
        id: '4-discover-10',
        type: 'explore',
        tutorText: '10% is de makkelijkste: deel gewoon door 10! Zet het percentage op 10.',
        interaction: 'slider',
        target: { percentage: 10 },
        showComponents: ['fillingBar', 'percentageSlider', 'insight'],
        hint: 'Schuif naar 10%. Deel door 10 = schuif de komma!',
      },
      {
        id: '4-building-blocks',
        type: 'intro',
        tutorText: 'Met deze drie bouwstenen kun je bijna elk percentage uitrekenen! 75%? Dat is 3\u00d725%. 30%? Dat is 3\u00d710%. Probeer het zelf!',
        ahaText: 'Onthoud: 50% = \u00f72, 25% = \u00f74, 10% = \u00f710',
        showComponents: ['fillingBar', 'percentageSlider', 'numberSlider', 'quickButtons', 'insight', 'buildingBlocks'],
      },
      {
        id: '4-challenge1',
        type: 'challenge',
        tutorText: 'Een jas kost \u20ac120. Je krijgt 25% korting. Hoeveel bespaar je?',
        interaction: 'slider',
        target: { percentage: 25 },
        showComponents: ['fillingBar', 'percentageSlider', 'insight'],
        hint: 'Een kwart van 120... deel door 4!',
      },
      {
        id: '4-challenge2',
        type: 'challenge',
        tutorText: 'Je leest 10% van een boek van 70 bladzijden. Hoeveel bladzijden is dat?',
        interaction: 'slider',
        target: { percentage: 10 },
        showComponents: ['fillingBar', 'percentageSlider', 'insight'],
        hint: '10% van 70 = 70 \u00f7 10 = ?',
      },
      {
        id: '4-complete',
        type: 'intro',
        tutorText: 'Je kunt nu met de bouwstenen-methode elk percentage uitrekenen! Op naar de vermommingen.',
